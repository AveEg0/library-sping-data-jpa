...
@EnableJpaRepositories(basePackages = "com.karmazyn.repositories")
@ComponentScan(basePackages = "com.karmazyn")
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.karmazyn");
    ...
    @Bean
    public PersonValidator personValidator(PersonService personService) {
