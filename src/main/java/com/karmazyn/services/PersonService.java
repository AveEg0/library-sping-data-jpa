...
import com.karmazyn.repositories.PeopleRepository;
...
public class PersonService {
    ...
    @Transactional
    public void update(int id, Person uptdatedPerson) {
        uptdatedPerson.setId(id);
        peopleRepository.save(uptdatedPerson);
    }
